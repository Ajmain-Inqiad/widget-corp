	...
	<div id="page">
		...
		<form action="edit_subject.php?subject=<?php echo urlencode($current_subject["id"]); ?>" method="post">
			<p>Menu Name<sup style="color:red">*</sup>: 
				<input type="text" name="menu_name" value="<?php echo htmlentities($current_subject["menu_name"]); ?>" required/>
			</p>
		...
		&nbsp;
		&nbsp;
		<a href="delete_subject.php?subject=<?php echo urlencode($current_subject["id"]); ?>" onclick="return confirm('Are you sure?'); ">Delete Subject</a><!--only place where i use js, the onclick function-->
	</div>
</div>
